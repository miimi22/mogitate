...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => '1200',
            'image' => '/storage/app/public/images/strawberry.png',
        ...
        $param = [
            'name' => 'オレンジ',
            'price' => '850',
            'image' => '/storage/app/public/images/orange.png',
        ...
        $param = [
            'name' => 'スイカ',
            'price' => '700',
            'image' => '/storage/app/public/images/watermelon.png',
        ...
        $param = [
            'name' => 'ピーチ',
            'price' => '1000',
            'image' => '/storage/app/public/images/peach.png',
        ...
        $param = [
            'name' => 'シャインマスカット',
            'price' => '1400',
            'image' => '/storage/app/public/images/muscat.png',
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => '800',
            'image' => '/storage/app/public/images/pineapple.png',
        ...
        $param = [
            'name' => 'ブドウ',
            'price' => '1100',
            'image' => '/storage/app/public/images/grapes.png',
        ...
        $param = [
            'name' => 'バナナ',
            'price' => '600',
            'image' => '/storage/app/public/images/banana.png',
        ...
        $param = [
            'name' => 'メロン',
            'price' => '900',
            'image' => '/storage/app/public/images/melon.png',
